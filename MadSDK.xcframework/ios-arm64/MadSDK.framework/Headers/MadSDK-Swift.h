...
#ifndef MADSDK_SWIFT_H
#define MADSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MadSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@class NSBundle;
/// Поднимает контент для keyboardAvoiding и добавляет pullBar
SWIFT_CLASS("_TtC6MadSDK25BottomSheetViewController")
...
@interface BottomSheetViewController (SWIFT_EXTENSION(MadSDK)) <UIViewControllerTransitioningDelegate>
...
SWIFT_CLASS("_TtC6MadSDK15MadSDKResources")
@interface MadSDKResources : NSObject
